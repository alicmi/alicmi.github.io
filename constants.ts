...
export const PROJECTS: Project[] = [
    ...
    { 
        ...
        gallery: [],
        text: "With our product–service system Co-Heat, we offer an approach to addressing the future of sustainable, shared energy resources in multi-party residential buildings. Following the Transition Design Guide developed by the Wuppertal Institute, we mapped out our user journey, future megatrends, and the Sustainable Development Goals our project addresses.\n Our Product-Service-System includes an digital information board in the stairwell of the useres houses and an energy/ressource management online platform for user support, maintenance, and individual settings. Additinally we developed, based on my initial draft, a new kind of thermostat. This thermostat allows users to select a limited base temperature while still enabling additional heating through a timer-controlled function, nudging the user through its' design to stay at the lowest selectable temperature.\nOur multi media system therefore enables housing communities to collectively manage their energy consumption, encourages low energy and water use by rewarding sustainable habits, and supports property owners in meeting political climate-protection regulations." 
    },
    { 
        id: "p6", 
