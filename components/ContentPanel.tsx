         ...
         <div className="relative">
            <div className="space-y-12 relative z-10">
                 ...
                 <div className="relative group">
                     <h2 className="text-base font-bold font-mono text-[#114552] mb-2 group-hover:text-[#FFB800] transition-colors">High school</h2>
                 ...
                 <div className="relative group pt-4">
                     <h2 className="text-base font-bold font-mono text-[#114552] mb-2 group-hover:text-[#FFB800] transition-colors">Internships and personal volunteering</h2>
                 ...
                 {/* Section 3: Education */}
                 <div className="relative group pt-4">
                     <h2 className="text-base font-bold font-mono text-[#114552] mb-2 group-hover:text-[#FFB800] transition-colors">Academic further education</h2>
    ...
    >
      ...
      {activeProject ? (
        ...
        <div className="flex flex-col justify-start h-full animate-fade-in relative">
           <div className="font-mono text-[9px] lg:text-[12px] leading-relaxed opacity-90 space-y-2 lg:space-y-4">
             <p>
